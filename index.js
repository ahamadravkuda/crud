var form = `<div>
  ...
  <select id="color" name="color" form="color">
...
<div class="form-group mt-3">
  ...
  <label for="cars">Choose a color:</label>
  <select id="color" name="color" form="color">
  <option value="${details[index].color}" class="form-control" id="newColor" placeholder="Update Your color">black</option>
  <option value="${details[index].color}"class="form-control" id="newColor" placeholder="Update Your color">pink</option>
  <option value="${details[index].color}"class="form-control" id="newColor" placeholder="Update Your color">blue</option>
  <option value="${details[index].color}"class="form-control" id="newColor" placeholder="Update Your color">red</option>
  </select>
  </div><br>
